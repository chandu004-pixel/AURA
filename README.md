...
Aura is built around the identity of authority, craftsmanship, and grassroots intelligence. The design mirrors high-end editorial broadsheets, utilizing minimalist typography, architectural silhouettes, and expansive negative space to frame cinematic product showcases.

---

## 🚀 Key Features

### 1. **Elastic Liquid Spotlight**: A custom cursor-driven spotlight effect in the Fashion Section that reveals hidden color layers on scroll, using advanced Framer Motion hooks.
